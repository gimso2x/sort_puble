...
var webSnb = function(){
	...
	webSnb += '<li><a href="table4.html">TABLE4</a></li>';
	webSnb += '<li><a href="title.html">TITLE</a></li>';
	webSnb += '<li><a href="alert.html">ALERT</a></li>';
	// webSnb += '<li><a href="popup.html">POPUP</a></li>';
	webSnb += '<li><a href="pqgrid.html">ParamQuery</a></li>'; 
	webSnb += '<li><a href="pqgrid2.html">ParamQuery2</a></li>'; 
	webSnb += '<li><a href="ckeditor.html">Ckeditor</a></li>'; 
	webSnb += '</ul>';
...
var mobileSnb = function(){
	...
	mobileSnb += '<li><a href="table1.html">TABLE</a></li>';
